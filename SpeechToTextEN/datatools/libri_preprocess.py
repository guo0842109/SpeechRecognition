...
from core import calcfeat_delta_delta
    ...
    for subdir, dirs, files in os.walk(root_directory):
        for f in files:
            ...
            if f.endswith('.flac'):
                try:
                    print(filename)
                    check_call([[os.getcwd()+'/SpeechToTextEN/datatools/flac.exe'], '-d', filename])
                    os.remove(filename)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", default="data/LibriSpeech", 
                help="Directory of LibriSpeech dataset", type=str)

    parser.add_argument("--save", default="data/libri", 
                help="Directory where preprocessed arrays are to be saved",
                        type=str)
